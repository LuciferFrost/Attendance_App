...
final _dummyRequests = [
  const _LeaveRequest(
    ...
    empCode: 'EMP-0042',
    date: 'Wed, 4 Jun 2025',
    leaveType: 'Leave type : casual leave',
  ...
  const _LeaveRequest(
    ...
    empCode: 'EMP-0042',
    date: 'Wed, 4 Jun 2025',
    leaveType: 'Leave type : Half day leave',
    remarks: 'Missed the reminder notification .....',
    slaLabel: '1h 45m',
  ),
  const _LeaveRequest(
    ...
    empCode: 'EMP-0042',
    date: 'Wed, 4 Jun 2025',
    leaveType: 'Leave type : Short leave',
    remarks: 'Missed the reminder notification .....',
    slaLabel: '1h 45m',
  ),
];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Column(
          children: [
            const ApprovalScreenHeader(title: 'Leave approvals'),
            ApprovalFilterTabs(
